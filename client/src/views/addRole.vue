  ...
  <div>
    ...
    <div class="mx-w-5xl mt-[40px]">
      ...
      <button class="absolute flex right-[100px] rounded-lg top-[150px] text-lg bg-black text-white px-4 py-2"
        @click="show = !show">เพิ่มรายชื่อ</button>
      <hr>
    </div>

    <div class="container mx-auto mx-w-5xl mt-[50px] flex grid grid-cols-5 gap-2 gap-y-[30px]">
    ...
    <div
      class="absolute mx-w-5xl top-[0px] w-full h-screen flex items-center justify-center backdrop-blur-sm backdrop-brightness-50 "
      v-if="show">
      <div class="w-[500px] h-[360px] bg-white">
        <div class=" px-[30px] pt-[30px]">
          ...
          <div class="mt-[20px] space-y-3">
            ...
            <input type="text" class="h-[37px] border-[1px] border-black rounded-xl p-2.5 w-[100%]" v-model="inName">
          </div>
          <div class="mt-[20px] space-y-3">
            <label class="font-light">Identification Number</label>
            <input type="text" class="h-[37px] border-[1px] border-black rounded-xl p-2.5 w-[100%]" v-model="inIdcard">
          </div>
          <div class="flex ml-[52%] mt-[30px] space-x-3">
            ...
            <button class="rounded-2xl border-[1px] border-black px-7 py-1.5 font-light" @click=" show = !show">ยกเลิก</button>
          </div>
        </div>
      </div>
    </div>
